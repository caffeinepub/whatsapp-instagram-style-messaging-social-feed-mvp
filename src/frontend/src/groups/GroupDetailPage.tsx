...
import { ArrowLeft, Crown, MessageSquare, UserPlus, Users } from "lucide-react";
import { useState } from "react";
import type { Group } from "../backend";
import ErrorState from "../components/states/ErrorState";
import LoadingState from "../components/states/LoadingState";
import { useInternetIdentity } from "../hooks/useInternetIdentity";
import { useGetPublicUserProfile, useMyGroups } from "../hooks/useQueries";
import InviteToGroupDialog from "./InviteToGroupDialog";

function MemberRow({
  principalStr,
  isCreator,
}: { principalStr: string; isCreator: boolean }) {
