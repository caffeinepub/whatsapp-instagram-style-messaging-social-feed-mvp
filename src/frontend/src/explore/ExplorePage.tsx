...
export default function ExplorePage() {
  ...
  const handleStartChat = async (userId: string, _username: string) => {
    if (!isAuthenticated) {
                      ...
                      {!blocked && (
                        <>
                          <Button
                            ...
                            onClick={() =>
                              following
                                ...
                                : handleFollow(userId, result.profile.username)
                            }
                            disabled={
                          ...
                          <Button
                            ...
                            variant="outline"
                            onClick={() =>
                              handleStartChat(userId, result.profile.username)
                            }
                      ...
                      <DropdownMenu>
                        ...
                        <DropdownMenuContent align="end">
                          {blocked ? (
                            <DropdownMenuItem
                              onClick={() =>
                                handleUnblock(userId, result.profile.username)
                              }
                            >
                            ...
                            <DropdownMenuItem
                              onClick={() =>
                                openBlockDialog(userId, result.profile.username)
                              }
